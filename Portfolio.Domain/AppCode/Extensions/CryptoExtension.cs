...
namespace Portfolio.Domain.AppCode.Extensions
{
    public static partial class Extension
    {
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}Portfolio.Domain.AppCode.Extensions");
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}2Portfolio.Domain.AppCode.Extensions");
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}1Portfolio.Domain.AppCode.Extensions");
